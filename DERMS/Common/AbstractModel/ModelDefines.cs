...
namespace Common.AbstractModel
{
    ...
    public enum ModelCode : long
    {
        ...
        MEASUREMENTDISCRETE_CURRENTOPEN = 0x1610000000060301,
        MEASUREMENTDISCRETE_NORMALOPEN  = 0x1610000000060401,
        ...
        DERENERGYSTORAGE                = 0x1121110000080000,
        DERENERGYSTORAGE_CAPACITY       = 0x1121110000080105,
        DERENERGYSTORAGE_STATEOFCHARGE  = 0x1121110000080205,
        DERENERGYSTORAGE_STATE          = 0x112111000008030A,
        DERENERGYSTORAGE_GENERATOR      = 0x1121110000000409,

        DERGENERATOR                = 0x1121120000000000,
        DERGENERATOR_DELTAPOWER     = 0x1121120000000105,
        DERGENERATOR_STORAGE        = 0x1121120000000209,

        DERSOLARGENERATOR           = 0x1121121000090000,

        DERWINDGENERATOR                = 0x11211210000A0000,
        DERWINDGENERATOR_CUTOUTSPEED    = 0x11211210000A0105,
        DERWINDGENERATOR_CUTINSPEED     = 0x11211210000A0205,
        DERWINDGENERATOR_NOMINALSPEED   = 0x11211210000A0305,

...
namespace TransactionManager.TransactionPhases
{
    ...
    {
        public CommitTransactionPhase(ReaderWriterLockSlim transactionStateLocker, ReaderWriterLock phaseLocker, TransactionStateWrapper transactionStateWrapper,
